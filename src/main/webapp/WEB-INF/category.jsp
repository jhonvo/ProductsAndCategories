			...
			<div class="d-flex flex-row flex-wrap">
				...
				<div class="col-md-6">
					...
					<input type="hidden" name="_method" value="put">
						...
						<button class="btn btn-info col-auto mt-4 px-3" type="submit">Add Product</button>
					</form>
				</div>
